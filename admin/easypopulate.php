...
define ('EP_FROOGLE_CURRENCY', 'CHF');  // default is 'USD'
...
define ('EP_ADDITIONAL_IMAGES_MAX', 3);  // default is 6, maximum number of columns
...
<td class="pageHeading" valign="top">Import/Export <p class="smallText"><?php
...
<?php } ?>
        ...
        <p>
          ...
          <p style="margin-top: 8px;"><a href="http://docs.swisscart.com/index.php?id=108" target="_blank" style="font-size:16px; text-decoration:underline;">EP Documentation</a></p>
