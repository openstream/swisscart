...
define('TABLE_HEADING_UNIT_PRICE', 'Preis (netto)');
define('TABLE_HEADING_UNIT_PRICE_TAXED', 'Preis (brutto)');
define('TABLE_HEADING_TOTAL_PRICE', 'Gesamt (netto)');
define('TABLE_HEADING_TOTAL_PRICE_TAXED', 'Gesamt (brutto)');
