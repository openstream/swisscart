...
define('TEXT_FILL_TAGS', 'Diese Option erlaubt das Ausfüllen der Metatags mit Headertags. Wählen Sie die passenden Einstellungen für Kategorien- und Produkt-Tags und klicken Sie dann auf Update. Wenn Sie "Nur leere Tags befüllen" gewählt haben werden Tags die bereits befüllt sind nicht überschrieben. Wenn die "Befülle Produkt-Metatag-Beschreibung mit Produktbeschreibung" Option gewählt wurde wird der Meta Description Tag mit der Produktbeschreibung befüllt. Wenn Sie eine Zahl in das Längenfeld eingebgeben haben wird die Beschreibung auf diese Anzahl Zeichen gekürzt.');
...
define('TEXT_FILL_WITH_DESCIPTION', 'Produkt Meta Description mit Produktbeschreibung f&uuml;llen?');
define('TEXT_LANGUAGE', 'Sprache:');
define('TEXT_LIMIT_TO', 'Begrenzen auf');
define('TEXT_NO', 'Nein');
define('TEXT_YES', 'Ja');
?>
