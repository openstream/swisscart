...
<tr class="dataTableHeadingRow">
        ...
        <td align=center class="dataTableHeadingContent" colspan="3"><?php echo ACTION_INFORMATION;?></td>
</tr>
<?php
$no=1;
if (sizeof($data) > 0) {
...
?></td>
    ...
    <td align=center class="dataTableContent">
                <?php echo '<a href="' . HTTP_CATALOG_SERVER . DIR_WS_CATALOG .'information.php?info_id=' . $val[information_id] . '" target="_blank">' . tep_image(DIR_WS_ICONS . 'preview.gif', VIEW_PAGE) . '</a>'; ?></td>
    <td align=center class="dataTableContent">
