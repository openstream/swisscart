      ...
      case 'update_order':
        ...
        if ( ($check_status['orders_status'] != $status) || tep_not_null($comments)) {
          ...
          if (isset($HTTP_POST_VARS['notify']) && ($HTTP_POST_VARS['notify'] == 'on')) {
            ...
            $email = STORE_NAME . "\n" . EMAIL_SEPARATOR . "\n" . EMAIL_TEXT_ORDER_NUMBER . ' ' . $oID . "\n" . EMAIL_TEXT_INVOICE_URL . ' ' . tep_catalog_href_link(FILENAME_CATALOG_ACCOUNT_HISTORY_INFO, 'order_id=' . $oID, 'SSL') . "\n" . EMAIL_TEXT_DATE_ORDERED . ' ' . tep_date_long($check_status['date_purchased']) . "\n\n" . $notify_comments . sprintf(EMAIL_TEXT_STATUS_UPDATE, $orders_status_array[$status]) . EMAIL_SIGNATURE;
...
?>
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <!-- PWA BOF -->
            <td class="pageHeading"><?php echo HEADING_TITLE . (($order->customer['id']==0)? TEXT_CUSTOMER_NO_ACCOUNT:''); ?></td>
            <!-- PWA EOF -->
...
// PWA BOF
      if ($orders['customers_id']==0) $orders['customers_name'] = $orders['customers_name'] . ' *';
// PWA EOF
...
?>
              <tr>
                <td colspan="5"><table border="0" width="100%" cellspacing="0" cellpadding="2">
				  ...
				  <tr>
				    <td colspan="2" class="smallText">*<?php echo TEXT_CUSTOMER_NO_ACCOUNT ?></td>
				  </tr>
                </table></td>
              </tr>
            </table></td>
