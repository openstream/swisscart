...
*/
  ...
  define('MODULE_PAYMENT_WORLDPAY_TEXT_TITLE', 'Zahlung per Lastschrift oder Kreditkarte ');
  define('MODULE_PAYMENT_WORLDPAY_TEXT_DESCRIPTION', 'Worldpay Zahlungsmodul');
?>