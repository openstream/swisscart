...
define('HEAD_TITLE_TAG_ALL','swisscart® - La solution e-commerce suisse');
define('HEAD_DESC_TAG_ALL','swisscart® - La solution e-commerce suisse');
define('HEAD_KEY_TAG_ALL','swisscart, oscommerce, ecommerce');
...
define('HEAD_DESC_TAG_DEFAULT','swisscart® - La solution e-commerce suisse');
define('HEAD_KEY_TAG_DEFAULT','swisscart, oscommerce, ecommerce');
