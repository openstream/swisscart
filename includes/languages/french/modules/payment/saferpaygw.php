...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_SAFERPAYGW_TEXT_DESCRIPTION', '<b>Saferpay Test account</b><br /><br />ACCOUNTID: 99867-94913159<br />Test card: 9451123100000004<br />valid to: 12/10, CVC 123<br /><br />Test card for 3D-Secure: 9451123100000111<br />Valid to: 12/10, CVC 123<br /><br /><b>Login to Backoffice<br /><a href="http://www.saferpay.com">www.saferpay.com:</a></b><br />User: e99867001<br />Password: Xajc3Kna');
  ...
  define('MODULE_PAYMENT_SAFERPAYGW_ZONE_TITLE', '<hr size=1><br>Payment Zone');
  ...
  define('MODULE_PAYMENT_SAFERPAYGW_MENUCOLOR_TITLE', '<hr size=1>Styling params of Saferpay VT (mandatory)&nbsp;<a href="images/saferpaygw_styling.jpg" target=_blank><img src="images/icons/graphics/unknown.jpg" width="15" border="0" alt="Help"></a><br><br>MENUCOLOR');
