...
define('HEAD_TITLE_TAG_ALL','swisscart® - Die Schweizer Webshop Lösung');
define('HEAD_DESC_TAG_ALL','swisscart® - Die Schweizer Webshop Lösung');
define('HEAD_KEY_TAG_ALL','oscommerce, ecommerce, schweiz, webshop, mietshop');
...
define('HEAD_DESC_TAG_DEFAULT','swisscart® - Die Schweizer Webshop Lösung');
define('HEAD_KEY_TAG_DEFAULT','oscommerce, ecommerce, schweiz, webshop, mietshop');
