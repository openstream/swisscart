...
define('HEAD_DESC_TAG_ALL','swisscart demo shop');
define('HEAD_KEY_TAG_ALL','swisscart, webshop, e-commerce');
...
define('HEAD_DESC_TAG_DEFAULT','swisscart demo shop');
define('HEAD_KEY_TAG_DEFAULT','swisscart, webshop, e-commerce');
