...
define('HEAD_TITLE_TAG_ALL','babycompany');
define('HEAD_DESC_TAG_ALL','babycompany');
define('HEAD_KEY_TAG_ALL','babycompany, produkte, artikel, baby, kinder');
...
define('HEAD_DESC_TAG_DEFAULT','babycompany');
define('HEAD_KEY_TAG_DEFAULT','babycompany');
