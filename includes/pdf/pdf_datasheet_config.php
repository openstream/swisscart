<?php
/*
  $Id: pdf_datasheet_creator v1.30 2003/03/11 13:46:29 ip chilipepper.it Exp $
...
*/
	...
	define('SHOW_LOGO',0);						// set to 1 if company logo must be displayed
	define('PDF_STORE_LOGO', DIR_WS_IMAGES . 'swisscart.gif');	// path to company logo. Default = gif type. If not, please change in pdf_datasheet_functions.php where PDF_STORE_LOGO is used
	define('PDF_STORE_LOGO_TYPE', 'GIF');
    	//StoreName Txt color
	define('HEADER_COLOR_TEXT','0,0,0');
	// Body Text color
	...
	define('SPECIAL_PRICE_COLOR_TEXT','208,47,48');
	define('SHOW_BACKGROUND',0);      //Shows bg color defined here below
	//Page Bg color
	define('PAGE_BG_COLOR','250,250,250');
	define('SHOW_WATERMARK',0);      //Prints Store Name as watermark, a bit of customization can be done in the functions file
	...
	define('MAX_IMAGE_WIDTH', 100);   //Width max in mm
	define('MAX_IMAGE_HEIGHT',100);   //Height max in mm
    ...
    define('SHOW_DATE_ADDED_AVAILABLE',0);
