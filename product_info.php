...
?>
				...
				echo '<a rel="lightbox[roadtrip]" class="productDetail" href="' . tep_image_link(DIR_WS_IMAGES . $product_info['products_image']) . '" title="'. tep_output_string($product_info['products_name'] .' Image 1 - '. $manufacturer['manufacturers_name']) .'">'. tep_image(DIR_WS_IMAGES . $product_info['products_image'], tep_output_string($product_info['products_name']), PRODUCT_INFO_IMAGE_WIDTH, PRODUCT_INFO_IMAGE_HEIGHT, 'hspace="0" vspace="0"') . '</a><br>' . tep_image_button('button_image_enlarge.gif', IMAGE_BUTTON_IMAGE_ENLARGE);
				} else { ?>
					<script language="javascript"><!--
										document.write('<?php echo '<a class="productDetail" href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], tep_output_string($product_info['products_name']), SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="5" vspace="5"') . '</a><br>' . tep_image_button('button_image_enlarge.gif', IMAGE_BUTTON_IMAGE_ENLARGE); ?>');
										//--></script>
										<noscript>
...
?>
				...
				<?php if (LIGHTBOX_ENABLE == 'true') {
				if ($product_info['products_image2']) echo '<div class="extraImage"><a rel="lightbox[roadtrip]" class="productDetail" href="' . tep_image_link(DIR_WS_IMAGES . $product_info['products_image2']) . '" title="'. tep_output_string($product_info['products_name'] .' Image 2 - '. $manufacturer['manufacturers_name']) .'">'. tep_image(DIR_WS_IMAGES . $product_info['products_image2'], addslashes($product_info['products_name']) . ' (Image 2)', SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="0" vspace="0"') . '</a></div>';
				if ($product_info['products_image3']) echo '<div class="extraImage"><a rel="lightbox[roadtrip]" class="productDetail" href="' . tep_image_link(DIR_WS_IMAGES . $product_info['products_image3']) . '" title="'. tep_output_string($product_info['products_name'] .' Image 3 - '. $manufacturer['manufacturers_name']) .'">'. tep_image(DIR_WS_IMAGES . $product_info['products_image3'], addslashes($product_info['products_name']) . ' (Image 3)', SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="0" vspace="0"') . '</a></div>';
				if ($product_info['products_image4']) echo '<div class="extraImage"><a rel="lightbox[roadtrip]" class="productDetail" href="' . tep_image_link(DIR_WS_IMAGES . $product_info['products_image4']) . '" title="'. tep_output_string($product_info['products_name'] .' Image 4 - '. $manufacturer['manufacturers_name']) .'">'. tep_image(DIR_WS_IMAGES . $product_info['products_image4'], addslashes($product_info['products_name']) . ' (Image 4)', SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="0" vspace="0"') . '</a><div>';
				} else {
