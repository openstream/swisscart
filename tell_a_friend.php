...
*/
	...
	if (isset($HTTP_GET_VARS['products_id'])) {
		$product_info_query = tep_db_query('select pd.products_name from ' . TABLE_PRODUCTS . ' p left join '.TABLE_PRODUCTS_TO_CATEGORIES .' p2c on p2c.products_id=p.products_id left join '. TABLE_CATEGORIES . ' c on c.categories_id=p2c.categories_id, ' . TABLE_PRODUCTS_DESCRIPTION . ' pd where c.categories_status=1 and p.products_status = "1" and p.products_id = "' . (int)$HTTP_GET_VARS["products_id"] . '" and p.products_id = pd.products_id and pd.language_id = "' . (int)$languages_id . '"');
			...
			<tr>
				<td><table border="0" width="100%" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="pageHeading" align="right"><?php if (HEADING_IMAGE_ENABLED == 'true') echo tep_image(DIR_WS_IMAGES . 'table_background_contact_us.gif', sprintf(HEADING_TITLE, $product_info['products_name']), HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
					</tr>
				</table></td>
			</tr>
			<tr>
